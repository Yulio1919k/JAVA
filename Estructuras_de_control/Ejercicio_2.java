...
public class Ejercicio_2 {
    public static void main(String[] args) {
        ...
        System.out.println("La ganancia de Enero es de: " + enero);
        ...
        System.out.println("La ganancia de Febrero es de: " + febrero);
        ...
        System.out.println("La ganancia de Marzo es de: " + marzo);
        ...
        System.out.println("La ganancia de Junio es de: " + junio);
        ...
        System.out.println("La ganancia de Julio es de: " + julio);
        ...
        System.out.println("La ganancia de Agosto es de: " + agosto);
        ...
        System.out.println("La ganancia de Septiembre es de: " + septiembre);
        ...
        System.out.println("La ganancia de Octubre es de: " + octubre);
        ...
        System.out.println("La ganancia de Noviembre es de: " + noviembre);

        System.out.print("Ingrese el ingreso para Diciembre: ");
        diciembre = ingresos.nextDouble();
        diciembre = (diciembre >= 1200 && diciembre <= 1250) ? diciembre + (diciembre * 60) / 100 : diciembre;
        System.out.println("La ganancia de Diciembre es de: " + diciembre);
    }
}
